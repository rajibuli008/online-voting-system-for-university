<html>
    <head>
        <title>University Online voting system - Registratrion</title>
        ...
        <center>
            ...
            <h2>Registration</h2>
                <form action="../api/register.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="number" name="mob" placeholder="Roll Number" required><br><br>
                    ...
                    <input style="width: 31%" type="text" name="add" placeholder="Department    Eg BCA / MCA/ BTECH" required><br><br>
